...
\settowidth{\enumlabelwidth}{\textbf{(m)}} % widest expected label
...
% Include content
\input{content/fibonacci.tex}
\input{content/logic.tex}
\input{content/set-theory.tex}
\input{content/maps.tex}
\input{content/fields.tex}
\input{content/systems-of-linear-equations.tex}
\input{content/vector-spaces.tex}
\input{content/span.tex}
\input{content/linear-independence.tex}
\input{content/bases-part-a.tex}
\input{content/bases-part-b.tex}
\input{content/dimension.tex}
\input{content/row-and-col-space.tex}
\input{content/sums-of-vector-spaces.tex}
\input{content/linear-maps.tex}
\input{content/linear-maps-and-bases.tex}
\input{content/matrices_a_matrix_multiplication.tex}
\input{content/matrices_b_change_of_basis.tex}
\input{content/matrices_c_column_rank_and_row_rank.tex}
\input{content/matrices_d_more_on_matrices_and_lineq.tex}
\input{content/matrices_e_elemntary_row_operations_revisited.tex}
\input{content/vs-out-of-old-ones.tex}
\input{content/misc.tex}
\input{content/determinants.tex}
\input{content/eigenvalues-eigenvectors.tex}
\input{content/euclidean-hermetian-spaces-a.tex}
