...
\begin{theorem}[The Canonical Isomorphism to the Bidual Space]
  Let $V$ be a finite-dimensional vector space over $K$. Then, there is a canonical isomorphism $\tau \colon V \to (V^*)^*$ given by: for $v \in V$, $\tau(v) \colon V^* \to K$ is the map $\tau(v)(\ell) := \ell(v)$ for all $\ell \in V^*$.
\end{theorem}
