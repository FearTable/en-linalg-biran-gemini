...
\begin{center}
  \begin{tikzpicture}[scale=1.3]
    ...
    % Vector highlights
    \draw[->, very thick, red] (0,0) -- (0.75, 1.5) node[midway, left=2pt] {$\vec{p_1 p_1'}$};
    \draw[->, very thick, orange] (0,0) arc (180:120:2) (0.75, 1.5) -- (1.5, 3) node[midway, left=2pt] {$\vec{p_1' p_1''}$};
  \end{tikzpicture}
\end{center}
